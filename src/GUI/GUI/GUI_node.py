...
class basic_GUI(Node):
    def __init__(self):
        ...
        y=threading.Thread(target=self.proccess2)
        y.start()
    ...
    def Update_GUI(self):
        ...
        sensors={'windvel':self.Wind_message.wind_speed,'windangle':self.Wind_message,
                 ...
                 'imuPitch':self.IMU_message.pitch,'latitude':self.Position_message.latitude,'longitude':self.Position_message.longitude,'rudder':self.rudder_msg.rudder_angle,'main_sail':self.sail_msg.sail_angle,'second_sail':0}
        # global app
    ...
    def proccess2(self,args=None):
        # GUI
        self.app = App()
        self.app.mainloop()
        self.app.quit()
# def proccess3(sensor):
#     app.update_from_ros(sensor)
#     global comm
#     app.after(1000, proccess3(comm))
def main(args=None):

...
#ifndef AUTOSAIL_SCORINGPLUGIN_HH_
#define AUTOSAIL_SCORINGPLUGIN_HH_
...
namespace autosail
{
  ...
  /// topic name is /autosail/task/info .
  ///
  ...
  /// Default is /autosail/debug/contact.
  ///
  /// <per_plugin_exit_on_completion>: Specifies whether to shut down after
  /// completion, for this specific plugin.
  /// Different from environment variable AUTOSAIL_EXIT_ON_COMPLETION, which is for
  ...
  ///   name="autosail::ScoringPlugin">
  ///   <vehicle>wamv</vehicle>
  ///   <task_name>my_task</task_name>
  ///   <task_info_topic>/autosail/task/info</task_info_topic>

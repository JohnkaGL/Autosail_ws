...
class autosail::SimpleHydrodynamicsPrivate
{
...
GZ_ADD_PLUGIN(autosail::SimpleHydrodynamics,
              sim::System,
              SimpleHydrodynamics::ISystemConfigure,
              SimpleHydrodynamics::ISystemPreUpdate)

GZ_ADD_PLUGIN_ALIAS(autosail::SimpleHydrodynamics,
                    "autosail::SimpleHydrodynamics")

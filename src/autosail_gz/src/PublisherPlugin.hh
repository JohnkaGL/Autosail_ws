...
#ifndef AUTOSAIL_PUBLISHERPLUGIN_HH_
#define AUTOSAIL_PUBLISHERPLUGIN_HH_
...
namespace autosail
{
  ...
  ///
  /// ## Example
  /// <plugin filename="libPublisherPlugin.so" name="autosail::PublisherPlugin">
  ///   <message type="gz.msgs.Param" topic="/autosail/wavefield/parameters"
  ///            at="0.0" every="2.0">
  ///     params {
  ///       key: "amplitude"
  ///       value {

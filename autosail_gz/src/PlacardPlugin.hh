...
#ifndef AUTOSAIL_PLACARD_PLUGIN_HH_
#define AUTOSAIL_PLACARD_PLUGIN_HH_
...
///
/// Here's an example:
///   <plugin name="autosail::PlacardPlugin" filename="libPlacardPlugin.so">
...
///     <robot_namespace>autosail</robot_namespace>

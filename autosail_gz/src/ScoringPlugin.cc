...
class ScoringPlugin::Implementation
{
  ...
  public: std::string taskInfoTopic = "/autosail/task/info";

  /// \brief Topic name to release the vehicle if locked to the world.
  public: std::string releaseTopic = "/autosail/release";
    ...
    sim::EventManager &_eventMgr)
{
  ...
  this->dataPtr->node.Subscribe("/autosail/contacts",
...
GZ_ADD_PLUGIN_ALIAS(autosail::ScoringPlugin,
                    "autosail::ScoringPlugin")
